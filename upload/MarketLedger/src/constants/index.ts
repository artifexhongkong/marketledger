...
export interface Currency {
  ...
  symbol: string;
  locale: string;
  rateToHKD: number; // 兌換率相對於 HKD
}

export const CURRENCIES: Record<CurrencyCode, Currency> = {
  HKD: { code: 'HKD', symbol: 'HK$', locale: 'zh-HK', rateToHKD: 1 },
  TWD: { code: 'TWD', symbol: 'NT$', locale: 'zh-TW', rateToHKD: 0.2 },
  THB: { code: 'THB', symbol: '฿', locale: 'th-TH', rateToHKD: 1.1 },
  MYR: { code: 'MYR', symbol: 'RM', locale: 'ms-MY', rateToHKD: 1.3 },
  SGD: { code: 'SGD', symbol: 'S$', locale: 'en-SG', rateToHKD: 0.75 },
  USD: { code: 'USD', symbol: 'US$', locale: 'en-US', rateToHKD: 0.13 },
};
