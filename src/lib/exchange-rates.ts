...
// Note: exchangeRates was removed from store (方案A：貨幣=符號，不轉換)
// This hook is kept for backward compatibility but returns a no-op formatter
...
export function useFormatCurrency() {
  ...
  return (amount: number) => {
    const symbol = { HKD: "HK$", TWD: "NT$", THB: "฿", MYR: "RM", SGD: "$", USD: "US$" }[currency as keyof any] || "$";
