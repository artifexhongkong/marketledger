...
// ── 主要支付方式、顏色常數、Toast 型別已移至 record-constants.ts ──
...
// ── 支付方式選擇器 ──
// PAYMENT_ICONS 和 PAYMENT_COLORS 已移至 record-constants.ts
...
// ── 新增支付方式 Modal（已移至 add-payment-modal.tsx）──
                    ...
                    <div className="flex-1 min-w-0 flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">
                          {formatCurrency(p.price, currency)} / {resolveDemoText(p.unit, t)}
                        </p>
                      </div>
                    </div>
                    {/* 移除編輯按鈕 — 用長按進入排序模式 */}
